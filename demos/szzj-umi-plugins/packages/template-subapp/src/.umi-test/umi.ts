...
async function render() {
  ...
  const basename = contextOpts.basename || '/@szzj/template-subapp';
  ...
  return (pluginManager.applyPlugins({
    ...
    initialValue() {
      const context = {
        ...
        routeComponents,
        pluginManager,
        rootElement: contextOpts.rootElement || document.getElementById('subapp-@szzj/template-subapp'),
        publicPath,
        runtimePublicPath,
        history,
        historyType,
...
export const mount = qiankun_genMount('subapp-@szzj/template-subapp');
export const unmount = qiankun_genUnmount('subapp-@szzj/template-subapp');
